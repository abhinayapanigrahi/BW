...
class siteConfig {
	...
	function __construct() {
			...
			$this->config = array(
							...
							"cookiePath"=>"/",
							"authentiction_fail_loginURL"=>"http://localhost:8080/bawarchiwala/login.php",
							"defaaultIndex"=>"http://localhost:8080/bawarchiwala/",
							"logOutPath"=>"../../login.php",
							"indexPage"=>"http://localhost:8080/bawarchiwala/index.php"																	
			);
	}
